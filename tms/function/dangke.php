...
function GetXiaozu($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<input class=\"form-control\" name=\"dangke_xiaozu_time$i\" value=".$sample[2].">");
		echo("</div>");
...
function GenerateNewXiaozu()
{
		...
		echo("<div class=\"col-md-3\">");
		echo("<input class=\"form-control\" name=\"new_dangke_xiaozu_time\">");
		echo("</div>");
		echo("<div class=\"col-md-6\">");
...
function GetSibian($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<input class=\"form-control\" name=\"dangke_sibian_time$i\" value=".$sample[2].">");
		echo("</div>");
...
function GenerateNewSibian()
{
		...
		echo("<div class=\"col-md-2\">");
		echo("<input class=\"form-control\" name=\"new_dangke_sibian_time\">");
		echo("</div>");
		echo("<div class=\"col-md-4\">");
...
function GetQiusuo($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<div class=\"row\">");
		echo("<div class=\"col-md-4\">");
		echo("<input class=\"form-control\" name=\"dangke_qiusuo_time$i\" value=".$sample[2].">");
		echo("</div>");
		echo("<div class=\"col-md-4\">");
...
function GenerateNewQiusuo()
{
		...
		echo("<div class=\"col-md-4\">");
		echo("<input class=\"form-control\" name=\"new_dangke_qiusuo_time\">");
		echo("</div>");
		echo("<div class=\"col-md-4\">");
