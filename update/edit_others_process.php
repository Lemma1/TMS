...
`Pass`='".$_POST["$tonguo"]."' WHERE `dangkeid` =".$sample[0];	
	...
	$new_qishu="new_basic_dangke_qishu";
	$new_pass="new_basic_dangke_pass";
	if ($_POST["$new_qishu"]!="" and $_POST["$new_pass"]!="")
	{
		$sql="insert into basicinfo_dangke values (null,".$_POST['otherid'].",'".$_POST["$new_qishu"]."','".$_POST["$new_pass"]."')";
		$DB->query($sql);
	}
