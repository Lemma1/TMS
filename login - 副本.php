...
<body style="background:url(img/bg.JPG) center top no-repeat;background-attachment:fixed;width:100%;">
<div class="container">

	<h1><strong>理论实践中心人员管理系统</strong></h1>
<div class="panel panel-info" style="width:40%;position:relative;top:100px;">
	<div class="panel-heading">请登录</div>
	<div class="panel-body">
	<form method="post" class="form-signin" role="form" action="">
		<?=$no?>
		<p><strong>用户名:</strong><input class="form-control" type="text" value="" name="account" /></p>
