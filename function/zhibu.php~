...
function GetLianxi($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<input class=\"form-control\" name=\"zhibu_lianxi_time$i\" value=".$sample[2].">");
		echo("</div>");
		echo("<div class=\"col-md-2\">");
...
function GenerateNewLianxi()
{
		...
		echo("<div class=\"col-md-2\">");
		echo("<input class=\"form-control\" name=\"new_zhibu_lianxi_time\">");
		echo("</div>");
		echo("<div class=\"col-md-2\">");
...
function GetHuibao($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<input class=\"form-control\" name=\"zhibu_sixiang_time$i\" value=".$sample[2].">");
		echo("</div>");
...
function GenerateNewHuibao()
{
		...
		echo("<div class=\"col-md-3\">");
		echo("<input class=\"form-control\" name=\"new_zhibu_sixiang_time\">");
		echo("</div>");
		echo("<div class=\"col-md-9\">");
...
function GetFanzhan($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<input class=\"form-control\" name=\"zhibu_fanzhanhui_time$i\" value=".$sample[2].">");
		echo("</div>");
		echo("<div class=\"col-md-2\">");
...
function GenerateNewFanzhan()
{
		echo("<div class=\"row\">");
		echo("<div class=\"col-md-4\">");
		echo("<input class=\"form-control\" name=\"new_zhibu_fanzhanhui_time\">");
		echo("</div>");
		echo("<div class=\"col-md-2\">");
...
function GetZhibu($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<div class=\"row\">");
		echo("<div class=\"col-md-2\">");
		echo("<input class=\"form-control\" name=\"zhibu_huodong_time$i\" value=".$sample[2].">");
		echo("</div>");
		echo("<div class=\"col-md-2\">");
...
function GenerateNewZhibu()
{
		...
		echo("<div class=\"col-md-2\">");
		echo("<input class=\"form-control\" name=\"new_zhibu_huodong_time\">");
		echo("</div>");
		echo("<div class=\"col-md-2\">");
