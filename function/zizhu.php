...
function GetLilun($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<input class=\"form-control date\" name=\"zizhu_lilun_time$i\" value=".$sample[2].">");
		echo("</div>");
		echo("<div class=\"col-md-3\">");
...
function GenerateNewLilun()
{
		...
		echo("<div class=\"col-md-3\">");
		echo("<input class=\"form-control date\"  name=\"new_zizhu_lilun_time\">");
		echo("</div>");
		echo("<div class=\"col-md-3\">");
...
function GetHuodong($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<input class=\"form-control date\" name=\"zizhu_huodong_time$i\" value=".$sample[2].">");
		echo("</div>");
		echo("<div class=\"col-md-2\">");
...
function GenerateNewHuodong()
{
		...
		echo("<div class=\"col-md-2\">");
		echo("<input class=\"form-control date\" name=\"new_zizhu_huodong_time\">");
		echo("</div>");
		echo("<div class=\"col-md-2\">");
...
function GetTougao($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<div class=\"row\">");
		echo("<div class=\"col-md-6\">");
		echo("<input class=\"form-control date\" name=\"zizhu_tougao_time$i\" value=".$sample[2].">");
		echo("</div>");
		echo("<div class=\"col-md-6\">");
...
function GenerateNewTougao()
{
		...
		echo("<div class=\"col-md-6\">");
		echo("<input class=\"form-control date\" name=\"new_zizhu_tougao_time\">");
		echo("</div>");
		echo("<div class=\"col-md-6\">");
