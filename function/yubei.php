...
function GetHuibao2($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<input class=\"form-control date\" name=\"yubei_huibao_time$i\" value=".$sample[2].">");
		echo("</div>");
...
function GenerateNewHuibao2()
{
		...
		echo("<div class=\"col-md-3\">");
		echo("<input class=\"form-control date\" name=\"new_yubei_huibao_time\">");
		echo("</div>");
		echo("<div class=\"col-md-9\">");
...
function GetZhongqi($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<div class=\"row\">");
		echo("<div class=\"col-md-3\">");
		echo("<input class=\"form-control date\" name=\"yubei_zhongqi_time$i\" value=".$sample[2].">");
		echo("</div>");
		echo("<div class=\"col-md-3\">");
...
function GetQuannian($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<div class=\"row\">");
		echo("<div class=\"col-md-3\">");
		echo("<input class=\"form-control date\" name=\"yubei_quannian_time$i\" value=".$sample[2].">");
		echo("</div>");
		echo("<div class=\"col-md-3\">");
...
function GetZhuanzheng($id)
{
	...
	for ($i=0;$i<$num;$i++)
	{
		...
		echo("<input class=\"form-control date\" name=\"yubei_zhuanzheng_time$i\" value=".$sample[2].">");
		echo("</div>");
